...
function Section2() {
  return (
    <div className='section-two-container'>
        <div className='row'>
            <div className='col-md-5 col-lg-5 col-xl-5 col-sm-5 col-xs-5 subtitle' style={{fontFamily:"Clash Display Light"}}> 
           <b style={{fontFamily:"Clash Display Medium"}}> META DRIP</b>  is XR Couture’s most ambitious multi-utility Digital Fashion NFT project. The 12-look digital wearables collection created by our cutting edge 3D artists was successfully launched at Decentraland's inaugural Metaverse Fashion Week and was featured in the Wall Street Journal and Vogue Business.
            ...
            <div className='col-md-7 col-lg-7 col-xl-7 col-sm-7 col-xs-6 text-right title d-flex justify-content-center flex-column' style={{fontFamily:"Clash Display Medium"}}>
                <p className='text-right title' style={{fontFamily:"Clash Display Medium"}}>“ So Many Metaverses</p>
